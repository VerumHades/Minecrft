...
class LoadedMesh{
    private:
        ...
        LoadedMesh(Mesh& mesh, std::initializer_list<GLVertexValueType> instance_types);
        friend class Mesh;
...
class Mesh{
    ...
    public:
        ...
        LoadedMesh load(std::initializer_list<GLVertexValueType> instance_types = {}) { return LoadedMesh(*this, instance_types); };
};
